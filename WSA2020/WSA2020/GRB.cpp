...
namespace GRB
{
	...
	Greibach greibach(NS('S'), TS('&'),
		...
		Rule(NS('S'), GRB_ERROR_SERIES + 0,
			...
			Rule::Chain(12, TS('f'), TS('t'), TS('i'), TS('('), TS(')'), TS('{'), NS('N'), TS('r'), NS('E'), TS(';'), TS('}'), NS('S')),
			Rule::Chain(12, TS('f'), TS('t'), TS('i'), TS('('), NS('F'), TS(')'), TS('{'), NS('N'), TS('r'), NS('E'), TS(';'), TS('}')),
			Rule::Chain(11, TS('f'), TS('t'), TS('i'), TS('('), TS(')'), TS('{'), NS('N'), TS('r'), NS('E'), TS(';'), TS('}')),
			Rule::Chain(8, TS('p'), TS('i'), TS('('), NS('F'), TS(')'), TS('{'), NS('N'), TS('}')),
			Rule::Chain(7, TS('p'), TS('i'), TS('('), TS(')'), TS('{'), NS('N'), TS('}')),
			Rule::Chain(9, TS('p'), TS('i'), TS('('), NS('F'), TS(')'), TS('{'), NS('N'), TS('}'), NS('S')),
			Rule::Chain(8, TS('p'), TS('i'), TS('('), TS(')'), TS('{'), NS('N'), TS('}'), NS('S')),
		...
		Rule(NS('N'), GRB_ERROR_SERIES + 1,
			...
			Rule::Chain(7, TS('$'), TS('i'), TS('('), NS('W'), TS(')'), TS(';'), NS('N')),
			Rule::Chain(6, TS('$'), TS('i'), TS('('), TS(')'), TS(';'), NS('N')),
			Rule::Chain(5, TS('$'), TS('i'), TS('('), TS(')'), TS(';')),
			Rule::Chain(6, TS('$'), TS('i'), TS('('), NS('W'), TS(')'), TS(';'))
		),
		Rule(NS('E'), GRB_ERROR_SERIES + 2,
			...
			Rule::Chain(5, TS('$'), TS('i'), TS('('), NS('W'), TS(')')),
			Rule::Chain(4, TS('$'), TS('i'), TS('('),  TS(')')),
			Rule::Chain(2, TS('i'), NS('M')),
			Rule::Chain(2, TS('l'), NS('M')),
			Rule::Chain(4, TS('('), NS('E'), TS(')'), NS('M')),
			Rule::Chain(5, TS('$'), TS('i'), TS('('), TS(')'), NS('M')),
			Rule::Chain(6, TS('$'), TS('i'), TS('('), NS('W'), TS(')'), NS('M'))
		),
