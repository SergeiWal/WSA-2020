...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(133, "Отсутствует закрывающая }"),
		ERROR_ENTRY(134, "Несоответствие количества парметров функции(процедуры)"),
		ERROR_ENTRY(135, "Несоответствие типов параметров функции(працедуры)"),
